...
// Implementation heavily inspired by https://github.com/maxogden/eol-stream/blob/master/index.js
function appendStream(text) {
  var crAtEnd = false;
  var detected = false;
  var eol;

  return through(detect, flush);

  function detect(chunk, _, callback) {
    if (detected) {
